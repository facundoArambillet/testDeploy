...
//         imgCarrusel.setAttribute("saturn-lazy",imagenes[i].imagen);
//         divCarrusel.appendChild(imgCarrusel);
...
//     var respuesta = await fetch("/muro");
//     if (respuesta.ok) {
...
var SATURN = function () {
    function SATURN(elem, data) {
        ...
        this.thumbs = $dev('<img>').addClass('saturn-thumbs')/*.attr('src', 'https://i.ibb.co/nQsD21Z/saturn.png');*/ //DERECHOS DE AUTOR
